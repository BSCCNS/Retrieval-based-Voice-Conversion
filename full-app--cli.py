...
sid0 = names????
spk_item = 0 # up to 2333 ???
vc_transform0 = 0 # ???
input_audio0 = "" # file.wav
file_index1 = "" # file.index
file_index2 = "" # sacado de index paths??
f0method0 =  ["pm", "harvest", "crepe", "rmvpe"]
                                 #   if config.dml == False
                                 #   else ["pm", "harvest", "rmvpe"]
resample_sr0 = 0 # 0 to 480000 ???
rms_mix_rate0 = 0.25 # 0 to 1 by 0.01
protect0 = 0.33 # 0 to 0.5 by 0.01
filter_radius0 = 3 # 0 to 7 by 1
index_rate1 = 0.75 # 0 to 1
f0_file = ""
